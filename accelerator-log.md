...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=demosteveschmidt&repo=tanzu-java-web-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=demosteveschmidt&repo=tanzu-java-web-app'
